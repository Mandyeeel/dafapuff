<template>
  <md-app md-mode="reveal">
    <md-app-toolbar class="md-primary">
      ...
      <span class="md-title">原料列表</span>
    </md-app-toolbar>

    <md-app-drawer :md-active.sync="menuVisible">
      <md-toolbar class="md-transparent" md-elevation="0">分類</md-toolbar>

      <md-list>
        <md-list-item>
          <md-icon>local_grocery_store</md-icon>
          <span class="md-list-item-text">原料</span>
        </md-list-item>

        <md-list-item>
          <md-icon>cake</md-icon>
          <span class="md-list-item-text">烘焙</span>
        </md-list-item>
      </md-list>
    </md-app-drawer>
            ...
            <md-ripple>
              <md-card-header>
                ...
                <md-menu md-size="big" md-direction="bottom-end">
                  ...
                  <md-menu-content>
                    <md-menu-item @click="editIngredient()">
                      <span>編輯</span>
                      <md-icon>edit</md-icon>
                    </md-menu-item>

                    <md-menu-item @click="deleteIngredient()">
                      <span>刪除</span>
  ...
  export default {
    ...
    methods: {
      ...
      updateIngredient() {
        if(this.edit === false){
          //add
          console.log(JSON.stringify(this.ingredient.brand))
